...
function MyProject() {
  ...
  const data = Theses===""?[]:Theses.map(thesis=>{return {title:thesis.title,scholar:thesis.scholarAdmn,sd:thesis.start_date.substring(0,10),url:`/sp/myproject/${thesis.scholarAdmn}/${thesis.id}`}});
  return (
