    ...
    return (
        ...
        <Layout className="site-layout">
          ...
          <Content style={{ margin: "25px 25px" }}>
            <MyProjectNav />
            <div className="site-layout-background row"  style={{ padding: 24, minHeight: 400 }}>
          <div className='rounded border border-2' style={{marginBottom: '10px'}}>
          <h2 className='text-secondary'><u>Create New Thread</u></h2>
            <Form {...layout} name="nest-messages"  validateMessages={validateMessages}>
                ...
                <Form.Item name={['user', 'description']} label="Description" style={{flex:'0'}}>
                    <Input.TextArea style={{height:'100px', float:'left'}} />
                 </Form.Item>
                <Form.Item wrapperCol={{ ...layout.wrapperCol, offset: 8 }}>
                    <Button type="primary" htmlType="submit" style={{float:'center'}}>
                        Submit
                    </Button>
                </Form.Item>
            </Form>
